...
For obvious purposes this script needs to be run as root, and should thus be used with caution
...
```
mkusers -p EXCITE17 -c /home/someotheruser/neurodata user{00..20}
```
